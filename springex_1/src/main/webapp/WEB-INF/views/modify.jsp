...
<script language="JavaScript" src="/ex/resources/js/members.js" ></script>
</head>
<body>
	<form action="modifyOk" method="post" name="reg_frm">
		...
		<input type="button" value="수정" onclick="updateInfoConfirm()">&nbsp;&nbsp;&nbsp; <input type="reset" value="취소" onclick="javascript:window.location='login'">
	</form>
</body>
</html>